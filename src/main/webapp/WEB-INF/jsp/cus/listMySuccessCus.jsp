...
<body>
	...
	<div id="center">
		...
		<div id="right">
			<span class="title">我的客户列表</span>
			<ul class="nav nav-tabs">
				<li id="successSC" class="active">
  					<a href="${pageContext.request.contextPath}/customer/listMySuccessCus.do">开发成功客户列表</a>
  				</li>
  				<li id="failSC">
  					<a href="${pageContext.request.contextPath}/customer/listMyFailCus.do">开发失败客户列表</a>
  				</li>
			</ul>
			<table id="listSC" class="table table-hover text-nowrap">
				...
				<tbody>
					<c:forEach items="${listMySuccessCus }" var="cus">
						<tr >
							<td>${cus.cusId}</td>
					    	<td>${cus.cusName}</td>
					    	<td>${cus.cusZone}</td>
					    	...
					    	<td>
								<a class="aEditCus" style="text-decoration:none;">
