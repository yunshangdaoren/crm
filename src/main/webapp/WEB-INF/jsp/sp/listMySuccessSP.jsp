	...
	<div id="center">
		...
		<div id="right">
			...
			<ul class="nav nav-tabs">
  				<li id="planSC"><a href="${pageContext.request.contextPath}/salePlan/listMyDevelopSP.do">正在开发列表</a></li>
  				<li id="failSC"><a href="${pageContext.request.contextPath}/salePlan/listMyFailSP.do">开发失败列表</a></li>
  				<li id="successSC"  class="active"><a href="${pageContext.request.contextPath}/salePlan/listMySuccessSP.do">开发成功列表</a></li>
			</ul>
			<table id="listSC" class="table table-hover text-nowrap">
				...
				<tbody>
					<c:forEach items="${listMySuccessSP }" var="sp">
						<tr >
							<td>${sp.spId}</td>
