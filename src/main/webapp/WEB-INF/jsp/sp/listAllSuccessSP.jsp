	...
	<div id="center">
		...
		<div id="right">
			...
			<ul class="nav nav-tabs">
  				...
  				<li id="failSP"><a href="${pageContext.request.contextPath}/salePlan/listAllFailSP.do">开发失败列表</a></li>
  				<li id="successSP" class="active"><a href="${pageContext.request.contextPath}/salePlan/listAllSuccessSP.do">开发成功列表</a></li>
			</ul>
			<table id="listSC" class="table table-hover text-nowrap">
				...
				<tbody>
					<c:forEach items="${listAllSuccessSP }" var="sp">
						<tr >
							<td>${sp.spId}</td>
		...
		<div class="scInfo" style="width:800px;height:510px;background:white;;margin:auto;margin-top:100px;">
			<div class="panel panel-primary" style="width:800px;">
    			...
    			<ul class="list-group" style="width:800px;height:460px;overflow:auto;">
        			...
        			<li class="list-group-item"><label>联系电话：</label><span class="scPhone"></span></li>
